...
- `batch` 命令用于多标的研究汇总，默认分钟线周期为 `15m`，把单标的结果写到 `outputs/batch/<symbol>/`，批量汇总写到 `outputs/batch/batch_summary.csv`，汇总报告索引写到 `reports/hstech_plus_513050/minute/hstech_15m_report_index.md`
