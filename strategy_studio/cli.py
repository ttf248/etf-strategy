...
def _add_strategy_arguments(parser: argparse.ArgumentParser) -> None:
    parser.add_argument(
        ...
        default="grid",
        help="策略类型，例如 grid、dca、ma_cross、macd_trend、donchian_breakout、volume_breakout、bollinger_reversion、daily_rebound、minute_rebound",
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    handlers = {
        ...
        "check-runtime": handle_check_runtime,
