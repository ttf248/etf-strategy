...
DEFAULT_SAMPLE_DATA_DIR = Path("data/samples")
DEFAULT_RUNTIME_DATA_DIR = Path("data/processed")
DEFAULT_DATA_PATH = DEFAULT_SAMPLE_DATA_DIR / "1810_hk_daily.csv"
DEFAULT_MINUTE_DATA_PATH = DEFAULT_SAMPLE_DATA_DIR / "1810_hk_15m.csv"
...
DEFAULT_EXAMPLE_REPORT_ROOT = Path("reports/examples")
DEFAULT_EXAMPLE_REPORT_INDEX_PATH = DEFAULT_EXAMPLE_REPORT_ROOT / "report_index.md"
DEFAULT_EXAMPLE_REPORT_DIR = DEFAULT_EXAMPLE_REPORT_ROOT / "1810_hk" / "daily"
DEFAULT_EXAMPLE_MINUTE_REPORT_DIR = DEFAULT_EXAMPLE_REPORT_ROOT / "1810_hk" / "minute"
