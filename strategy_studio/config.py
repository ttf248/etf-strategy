...
DEFAULT_RUNTIME_DATA_DIR = Path("data/processed")
# 默认 CSV 路径放在未纳入版本控制的运行目录，避免仓库继续沉淀样例行情。
DEFAULT_DATA_PATH = DEFAULT_RUNTIME_DATA_DIR / "1810_hk_daily.csv"
DEFAULT_MINUTE_DATA_PATH = DEFAULT_RUNTIME_DATA_DIR / "1810_hk_15m.csv"
